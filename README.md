...
- 曲库共 140 首。专辑曲与个人单曲固定加入；影视原声和每档综艺可在出发前逐项开关。默认开启影视原声及“经典音乐综艺”组，其他音乐综艺默认关闭。
- 可以选择“只保留独唱”或“包含合唱”。合唱不是独立来源分类，而是个人单曲或其他来源上的 `collab` 标签。
- 固定采用 32 强路线：32 强 → 16 强 → 8 强 → 4 强 → 2 强 → 心中 Top 1。首轮以最多四选一快速海选；若胜者少于 27 首，会从离岛歌曲中追加若干场四选一加赛，因此最终手动送回的遗珠永远不超过 5 首。同来源歌曲和高种子歌曲会尽量分散，选择越快，后续二选一同组内越靠上，但不影响配对。
...
手机端歌曲卡采用手作纸张与胶带风格：标题保持深色无衬线字，并使用明艳细色条与松散彩色斜线增加层次；左侧封面锁定为完整 1:1 显示。
