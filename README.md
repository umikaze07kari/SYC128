...
- 固定采用 32 强路线：32 强 → 16 强 → 8 强 → 4 强 → 2 强 → 冠军。首轮以最多四选一快速海选；若胜者少于 27 首，会从离岛歌曲中追加若干场四选一加赛，因此最终手动送回的遗珠永远不超过 5 首。同来源歌曲和高种子歌曲会尽量分散，选择越快，后续二选一同组内越靠上，但不影响配对。
...
手机端歌曲卡采用成熟清透的 C3 票券风格：白色承担约三分之二留白，右侧约三分之一使用同色系半透明色块；标题、标签、音符、胶带与细边沿用同一主色家族，左侧封面锁定为完整 1:1 显示。
